<?php
	...
	class Photoupload{
		...
		function __construct($photoinput, $filetype){
			$this->photoinput = $photoinput; //$this->photoinput saab võrdseks lihtsalt photoinput'iga
			//this viitab klassi lokaalsetele muutujatele
		...
		public function resizePhoto($w, $h, $keeporigproportion = true){
			//funktsiooni lokaalsete muutujate nimesid ei ole vaja muuta, muuta on vaja vaid klassi muutujaid
